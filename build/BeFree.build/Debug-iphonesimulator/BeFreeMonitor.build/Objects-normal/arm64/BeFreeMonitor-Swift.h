...
#ifndef BEFREEMONITOR_SWIFT_H
#define BEFREEMONITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BeFreeMonitor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_RESILIENT_CLASS("_TtC13BeFreeMonitor30DeviceActivityMonitorExtension")
@interface DeviceActivityMonitorExtension : DeviceActivityMonitor
